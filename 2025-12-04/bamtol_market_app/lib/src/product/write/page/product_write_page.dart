...
class ProductWritePage extends GetView<ProductWriteController> {
  ...
  Widget get _divder =>
      const Divider(color: Color(0xff3C3C3E), indent: 25, endIndent: 25);
  ...
  Widget build(BuildContext context) {
    return CommonLayout(
      appBar: AppBar(
        ...
        centerTitle: true,
        title: const AppFont('내 물건 팔기', fontWeight: FontWeight.bold, size: 18),
        actions: [
          Obx(
            () => GestureDetector(
              onTap: () {
            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  _divder,
                  _ProductDescription(),
                  Container(height: 5, color: Color(0xff3C3C3E)),
      ...
      onTap: () async {
        if (kIsWeb) {
          ...
          if (images.isNotEmpty) {
            controller.changeSelectedImages(images);
          }
        } else {
          var selectedImages = await Get.toNamed(
            '/MultifulImageView',
            arguments: controller.selectedImages,
          );
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                const AppFont('/10', size: 13, color: Color(0xff868B95)),
              ],
            ),
          ],
        ),
